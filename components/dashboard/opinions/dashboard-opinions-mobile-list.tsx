...
import DashboardOpinionsMobileListCard from './dashboard-opinions-mobile-list-card'
...
export default function DashboardOpinionsMobileList({
  opinions,
}: MobileListProps) {
    ...
    <div className="w-full block md:hidden">
      ...
      <div className="space-y-2 w-full">
        {currentItems.map((opinion, index) => {
          return (
            <DashboardOpinionsMobileListCard
              key={opinion.id}
              opinion={opinion}
